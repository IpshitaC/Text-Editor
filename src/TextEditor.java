...
public class TextEditor extends JFrame {
   ...
   /* private PopupMenu SaveAs;
    private PopupMenu Quit;
    private PopupMenu Save;
    private PopupMenu Open;
    private PopupMenu New;
    private PopupMenu Cut;
    private PopupMenu Copy;
    private PopupMenu Paste;*/
